  ...
  <div class="container grid">
    <div class="card" data-tags="degree">
      <div class="center">
        ...
        - ((en))In progress, 8/9 semesters((/en))((es))En curso, 8/9 semestres((/es))
      </div>
     ...
     <div class="card" data-tags="degree">
      <div class="center">
        ...
        ### Génie Informatique ((en))(Computer Engineering)((/en))((es))(Ingeniería Informática)((/es)) @ UTC
        - ((en))Study Abroad Program 2025((/en))((es))Programa de Estudios en el Extranjero 2025((/es))
      </div>
    </div>
  </div><!--container Elements-->
    ...
    <div class="card" data-tags="certificate ai">
      ...
      <div class="center">
        <p>
          ...
          [PDF](./credentials/docs/754_arielemilio_parra_EN.pdf)
        </p>
      </div>
    </div>
    ...
    <div class="card" data-tags="event programming">
      ...
      <div class="center">
        <p>
          ...
          [PDF](./credentials/docs/2025-ICPC_Gran_Premio_de_Mexico-Ariel_Emilio_Parra_Martínez-PLACE.pdf)
        </p>
      </div>
    </div>    
    <div class="card" data-tags="event programming">
      ...
      <div class="center">
        <p>
          ...
          [PDF](./credentials/docs/ANIEI-Ariel_Emilio_Parra_Martínez.pdf)
        </p>
      </div>  
    </div>
    <div class="card" data-tags="event programming">
